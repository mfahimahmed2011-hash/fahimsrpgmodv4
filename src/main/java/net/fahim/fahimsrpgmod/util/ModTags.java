    ...
    public static class Blocks {
        ...
        public static final TagKey<Block> INCORRECT_FOR_PINK_GARNET_TOOL = createTag("incorrect_for_pink_garnet_tool");
            ...
            private static TagKey<Block> createTag(String name) {
                return TagKey.of(RegistryKeys.BLOCK, Identifier.of(FahimsRPGMod.MOD_ID, name));
            }

        }

        public static class Items {
        public static final TagKey<Item> TRANSFORMABLE_ITEMS =createTag("transformable_items.json");

            private static TagKey<Item> createTag(String name) {
                return TagKey.of(RegistryKeys.ITEM, Identifier.of(FahimsRPGMod.MOD_ID, name));
            }
        }
    }
