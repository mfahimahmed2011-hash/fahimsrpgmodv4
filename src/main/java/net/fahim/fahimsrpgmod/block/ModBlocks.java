...
public class ModBlocks {
     ...
     public static final Block PINK_GARNET_STAIRS = registerBlock("pink_garnet_stairs",
      ...
      public static final Block PINK_GARNET_SLAB = registerBlock("pink_garnet_slab",
        ...
        public static final Block PINK_GARNET_BUTTON = registerBlock("pink_garnet_button",
           new ButtonBlock(BlockSetType.IRON,2, AbstractBlock.Settings.create().strength(2.5f).requiresTool().noCollision()));
        public static final Block PINK_GARNET_PRESSURE_PLATE = registerBlock("pink_garnet_pressure_plate",
           new PressurePlateBlock(BlockSetType.IRON, AbstractBlock.Settings.create().strength(2.5f).requiresTool()));
    ...
    private static Block registerBlock(String name, Block block) {
        ...
        return Registry.register(Registries.BLOCK, Identifier.of(FahimsRPGMod.MOD_ID, name),block);
    }

private static void registerBlockItem(String name, Block block) {
    Registry.register(Registries.ITEM, Identifier.of(FahimsRPGMod.MOD_ID, name),
   ...
   public static void registerModBlocks() {
       ...
       FahimsRPGMod.LOGGER.info("Registering Mod blocks for" + FahimsRPGMod.MOD_ID);
